...
void setupFTM0() {
    ...
    //FTM0_MOD = 12000;
    // 100Hz PWM signal
    FTM0_MOD = 30000; // 48MHz / 16 / 30000 = 100Hz
#endif
...
// Initial values (3000 = 1ms)
#if MOTORS == 3
    MOTOR_0_VALUE = MOTOR_INIT_VALUE;
    MOTOR_1_VALUE = MOTOR_INIT_VALUE;    
    MOTOR_2_VALUE = MOTOR_INIT_VALUE;  
    ...
    MOTOR_1_VALUE = MOTOR_INIT_VALUE;    
    MOTOR_2_VALUE = MOTOR_INIT_VALUE;  
    MOTOR_3_VALUE = MOTOR_INIT_VALUE;  
    ...
    MOTOR_2_VALUE = MOTOR_INIT_VALUE;  
    MOTOR_3_VALUE = MOTOR_INIT_VALUE;  
    MOTOR_4_VALUE = MOTOR_INIT_VALUE;  
    MOTOR_5_VALUE = MOTOR_INIT_VALUE;  
    ...
    MOTOR_4_VALUE = MOTOR_INIT_VALUE;  
    MOTOR_5_VALUE = MOTOR_INIT_VALUE;  
    MOTOR_6_VALUE = MOTOR_INIT_VALUE;  
    MOTOR_7_VALUE = MOTOR_INIT_VALUE;  
